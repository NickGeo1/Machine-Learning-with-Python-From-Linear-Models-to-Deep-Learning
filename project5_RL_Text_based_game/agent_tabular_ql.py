...
def epsilon_greedy(state_1, state_2, q_func, epsilon):
    ...
    if random_action:
        ...
        action_index, object_index = np.unravel_index(q_func[state_1, state_2, :, :].argmax(), shape=(NUM_ACTIONS, NUM_OBJECTS) )
...
def tabular_q_learning(q_func, current_state_1, current_state_2, action_index,
    ...
    if not terminal:
        ...
        q_func[current_state_1, current_state_2, action_index, object_index] = \
        (1 - ALPHA)*q_func[current_state_1, current_state_2, action_index, object_index] + ALPHA*reward
...
def run_episode(for_training):
    ...
    while not terminal:
        ...
        # TODO Your code here
        current_room_idx, current_quest_idx = dict_room_desc[current_room_desc], dict_quest_desc[current_quest_desc]
        ...
        if for_training:
            # update Q-function.
            # TODO Your code here
            next_room_idx, next_quest_idx = dict_room_desc[next_room_desc], dict_quest_desc[next_quest_desc]
            tabular_q_learning(q_func, current_room_idx, current_quest_idx, action_idx, object_idx, reward, next_room_idx, next_quest_idx, terminal)
