...
# Best model is pegasus with T = 25 and L = 0.01. acc = 0.806

b_theta, b_theta_0 = p1.pegasos(train_bow_features, train_labels, 25, 0.01)
acc = p1.accuracy(p1.classify(test_bow_features, b_theta, b_theta_0), test_labels)
print(f"The accuracy of the best model is: {acc}")
